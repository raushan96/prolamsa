...
public class InitialDataSystemSetup_Backup extends AbstractSystemSetup
{
	private static final String BTG_EXTENSION_NAME = "btg";

	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup_Backup.class);
