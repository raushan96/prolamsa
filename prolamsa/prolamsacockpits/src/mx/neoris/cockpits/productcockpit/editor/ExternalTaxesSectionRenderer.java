 ...
 *  
 */
package mx.neoris.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("prolamsacockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("prolamsacockpits.product.externalTaxes"));
