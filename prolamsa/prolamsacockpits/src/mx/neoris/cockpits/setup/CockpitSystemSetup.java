 ...
 *  
 */
package mx.neoris.cockpits.setup;
...
import mx.neoris.cockpits.constants.ProlamsaCockpitsConstants;
 ...
 */
@SystemSetup(extension = ProlamsaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ProlamsaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ProlamsaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ProlamsaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/prolamsacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
