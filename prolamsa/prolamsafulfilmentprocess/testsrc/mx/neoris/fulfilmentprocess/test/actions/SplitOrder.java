 ...
 *  
 */
package mx.neoris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ProlamsaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ProlamsaFulfilmentProcessConstants.PARENT_PROCESS);
