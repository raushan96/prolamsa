...
public class PlaceOrderForm
{
	...
	private String negotiablePrices;
	...
	/**
	 * @return the negotiablePrices
	 */
	public String getNegotiablePrices() {
		return negotiablePrices;
	}

	/**
	 * @param negotiablePrices the negotiablePrices to set
	 */
	public void setNegotiablePrices(String negotiablePrices) {
		this.negotiablePrices = negotiablePrices;
	}
}
