 ...
 *  
 */
package mx.neoris.storefront.renderer;
...
import mx.neoris.storefront.tags.Functions;
...
public class CMSLinkComponentRenderer implements CMSComponentRenderer<CMSLinkComponentModel>
{
	...
	public void renderComponent(final PageContext pageContext, final CMSLinkComponentModel component) throws ServletException, IOException
	{
		try
		{
			if (component.getNavigationLinkFunction() != null)
				renderComponentWithValidation(pageContext, component);
			else
			{
	...
	/*
	 * NEORIS_CHANGE extend CMSLinkComponent with a validation function to allow navigation to a particular link
	 */
	public void renderComponentWithValidation(final PageContext pageContext, final CMSLinkComponentModel component) throws ServletException, IOException
	{
		try
		{
			final String url = getUrl(component);
			...
			out.write(component.getNavigationLinkFunction());
			out.write("('");
			out.write(encodedUrl);
			out.write("')\" ");
			out.write("title=\"");
