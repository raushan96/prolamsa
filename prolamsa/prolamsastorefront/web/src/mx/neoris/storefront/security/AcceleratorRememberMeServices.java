...
import mx.neoris.storefront.web.wrappers.RemoveEncodingHttpServletRequestWrapper;
...
public class AcceleratorRememberMeServices extends TokenBasedRememberMeServices
{
	...
	{
		String id = getCustomerFacade().getCurrentCustomer().getUid();
		
		neorisFacade.deleteDataB2BCustomerLogout(id);
