...
import mx.neoris.storefront.forms.ForgottenPwdForm;
import mx.neoris.storefront.forms.UpdatePwdForm;
...
/**
 * Controller for the forgotten password pages. Supports requesting a password
 * reset email as well as changing the password once you have got the token that
 * was sent via email.
 */
@Controller
@Scope("tenant")
...
public class PasswordResetPageController extends AbstractPageController
{
	...
	final UpdatePwdForm form, final BindingResult bindingResult, final Model model, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		if (bindingResult.hasErrors())
		{
