...
<div class="span-24 last grid-buttons">
	<spring:url value="${product.url}/grid/skusFutureStock"	var="skusFutureStockUrl" />
	<button class="form update_future_stock_button" data-skus-id="${skusId}" data-skus-future-stock-url="${skusFutureStockUrl}" id="update-future-availability-button-${loopIndexColor}">
