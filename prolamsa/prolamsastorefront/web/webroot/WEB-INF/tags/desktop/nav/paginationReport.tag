...
<%@ attribute name="neorisSortBy" required="false" type="java.lang.Boolean" %>
...
<div class="prod_refine">
	...
	<!-- NEORIS_CHANGE -->
	<c:if test="${includeSortDropdown}">
		<c:choose>
			<c:when test="${neorisSortBy}">
				<div class="search-form-options">
		
				<formUtil:formSortDropdownSortBy
					sorts="${sorts}"
