...
<%@ attribute name="b2BPermissionForm" required="true"
	type="mx.neoris.storefront.forms.B2BPermissionForm"%>
...
<form:form action="${saveUrl}" id="b2BPermissionForm"
	commandName="b2BPermissionForm" method="POST">
		...
		<form:input type="hidden" name="b2BPermissionTypeData.name"
			...
			: ${b2BPermissionForm.b2BPermissionTypeData.name}
			<br><br>
	...
	<ycommerce:testId code="Permission_Save_button">
		<button type="submit" class="button yellow positive button-float-right"><spring:theme code="text.company.managePermissions.edit.saveButton" text="Save" /></button>
	</ycommerce:testId>
</form:form>
