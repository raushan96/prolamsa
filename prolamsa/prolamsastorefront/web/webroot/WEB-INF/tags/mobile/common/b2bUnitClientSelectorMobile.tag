...
<%@ attribute name="selectedB2BUnit" required="true" type="String" %>
...
<div>
<span class="${spanCSS}"><spring:theme code="text.account.balanceStatement.list.client"/></span>
<select id="customer" name="customer" class="${dropDownCSS}" style="border: solid 3px gray;">
