...
<div class="item_container_holder top">
	...
	<div class="last">
		<a href="${editUserUrl}"  class="mycompany right pad_right edit"><spring:theme code="text.company.manageUser.button.edit" text="Edit"/></a>
		<c:choose>
			<c:when test="${customerData.active}">
				<a href="${disableUserUrl}" class="mycompany right pad_right  disable"><spring:theme code="text.company.manageusers.button.disableuser" text="Disable User"/></a>
			</c:when>
			<c:otherwise>
				<c:choose>
					<c:when test="${customerData.unit.active}">
						<form:form action="${enableUserUrl}">
							<button class="mycompany right pad_right enable"><spring:theme code="text.company.manageusers.button.enableuser" text="Enable User"/></button>
						</form:form>
					</c:when>
					<c:otherwise>
						<a class="mycompany right pad_right disabled"><spring:theme code="text.company.manageusers.button.enableuser" text="Enable User"/></a>
					</c:otherwise>
				</c:choose>
			</c:otherwise>
		</c:choose>
...
<div class="item_container_holder">
	...
	<div class="last">
		<a href="${approversUrl}" class="mycompany right pad_right edit"><spring:theme code="text.company.manage.units.users.button.edit" text="edit"/></a>
	</div>
	<div class="item_container">
...
<div class="item_container_holder">
	...
	<div class="last">
		<a href="${permissionsUrl}" class="mycompany right pad_right edit"><spring:theme code="text.edit" text="Edit"/></a>
	</div>
	<div class="item_container">
...
<div class="item_container_holder">
	...
	<div class="last"><a href="${usergroupsUrl}" class="mycompany right pad_right edit"><spring:theme code="text.edit" text="Edit"/></a></div>
	<div class="item_container">
