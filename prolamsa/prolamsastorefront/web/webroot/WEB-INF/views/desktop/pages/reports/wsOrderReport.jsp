...
<script type="text/javascript">
        	...
        	var valorXML = jQuery("#xmlResponse").val(); 
          	...
          	$("#prods").jqGrid({
          		datatype: 'xmlstring',
          		datastr : valorXML,
          		colNames:["Sales Group",  "Sales Rep", "Order Code", "Customer", "Product Code", "Product Desc", "Due Date", "Customer Promise", "OD", "Net Tons",
                 ...
                 colModel:[
                     ...
                     {name:"productCode", width:150, xmlmap:">Product"},
                     ...
                     {name:"dueDate", width:200, xmlmap:">DueDate", sorttype:'date',type: 'date' , cellsformat: 'yy-mm-dd',filtertype: 'date',
                         ...
                         {name:"customerPromise", width:230, xmlmap:">EstimatedDelivery", sorttype:'date',type: 'date' , cellsformat: 'yy-mm-dd',filtertype: 'date',
                        	 formatter: 'date', formatoptions: {newformat: 'Y-m-d'}, datefmt: 'Y-m-d', searchoptions: {
                             // dataInit is the client-side event that fires upon initializing the toolbar search field for a column
                             // use it to place a third party control to customize the toolbar
                             dataInit: function (element) {
                     ...
                     {name:"od", width:75, xmlmap:">ODIn", align:"right"},
                     {name:"netTons", width:125, xmlmap:">QuantityInDefaultUnits"},
                     {name:"quantity", width:125, xmlmap:">OrderQuantityPieces"},
                     {name:"completedQty", width:175, xmlmap:">CompletedQuantityResolved"},
                 ...
                 caption: '<spring:theme code="text.account.orderReport" />',
                  	 loadonce: true,
     				 viewrecords: true,
                     autowidth: true,
                     height: 440,
                ...
                $("#prods").toggleSubGridRow(row_id);
                     ...
                     $("#" + subgrid_table_id).jqGrid( {
                         colNames: ['Operation Code', 'Slot Code', 'Run Code', 'Workcenter', 'Start Date', 'End Date', 'Status', 'Completed Qty', 'Remaining Qty'],
                         datatype:'xmlstring',
                         datastr: valorXML,
                         colModel: [
                             {name:"OperationNumber", index:"OperationNumber", width:80, xmlmap:"OperationNumber"},
                             {name:"BlockCode", index:"BlockCode", width:80, xmlmap:"BlockCode"},
                             {name:"RunCode", index:"RunCode", width:80, xmlmap:"RunCode"},
                             ...
                             {name:"CompletedQty", index:"CompletedQty", width:80, xmlmap:"CompletedQuantityInDefaultUnits", align:"right"},
                             {name:"RemainingQuantity", index:"RemainingQuantity", width:80, xmlmap:"RemainingQuantityInDefaultUnits", align:"right"}
