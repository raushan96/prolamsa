	...
	document.getElementById("gbox_prodsExcel").style.display = 'none';
    	...
    	<script type="text/javascript">
        	...
        	$("#prods").jqGrid({
          		datatype: 'xmlstring',
          		datastr : valorXML,
          		colNames:["Block code",  "Status", "Filter code (block)", "Ciclo", "Start date", "End date", "Slot Counter", "seccion_dimension", "Unadjusted volume", 
                    	  "Unadjusted duration", "Total duration", "Available duration", "Free duration", "Is late?", "Is overbooked?", "Overbooked duration", "Overbooking %"], 
                           colModel:[
								{name:"OrderCode", width:160, xmlmap:">Code", key:true},
								{name:"Estatus", width:120, xmlmap:">Status"} ,
								{name:"Filter", width:140, xmlmap:">Filter"} ,
								{name:"Ciclo", width:110, xmlmap:">Ciclo"} ,
								{name:"starDate", width:250, xmlmap:">Start", sorttype:'date',type: 'date' , cellsformat: 'yy-mm-dd',filtertype: 'date',
	                              	 formatter: 'date', formatoptions: {newformat: 'Y-m-d'}, datefmt: 'Y-m-d', searchoptions: {
	                                   // dataInit is the client-side event that fires upon initializing the toolbar search field for a column
	                                   // use it to place a third party control to customize the toolbar
	                                   dataInit: function (element) {
	                                       $(element).datepicker({
	                                           id: 'starDate_datePicker',
	                                           dateFormat: 'yy-mm-dd',
	                                           maxDate: new Date(2020, 0, 1),
	                                           showOn: 'focus'
	                                       });
	                                   },sopt:['eq','ne','le','lt','gt','ge'] }},
	                            {name:"endDate", width:250, xmlmap:">End", sorttype:'date',type: 'date' , cellsformat: 'yy-mm-dd',filtertype: 'date',
                              	 formatter: 'date', formatoptions: {newformat: 'Y-m-d'}, datefmt: 'Y-m-d', searchoptions: {
                                   // dataInit is the client-side event that fires upon initializing the toolbar search field for a column
                                   // use it to place a third party control to customize the toolbar
								...
								{name:"SlotCounter", width:190, xmlmap:">SlotCounter"} ,
								{name:"Seccion_dimension", width:150, xmlmap:">Seccion_dimension"} ,
								{name:"UnadjustedVolume", width:150, xmlmap:">UnadjustedVolume"} ,
								{name:"UnadjustedDuration", width:300, xmlmap:">UnadjustedDuration"} ,
								{name:"TotalDuration", width:190, xmlmap:">TotalDuration"} ,
								{name:"AvailableDuration", width:190, xmlmap:">AvailableDuration"} ,
								{name:"FreeDuration", width:150, xmlmap:">FreeDuration"} ,
								{name:"IsLate", width:190, xmlmap:">IsLate"} ,
								{name:"IsOverbooked", width:300, xmlmap:">IsOverbooked"} ,
								{name:"OverbookedDuration", width:400, xmlmap:">OverbookedDuration"} ,
								{name:"OverbookedCoveragePercentage", width:190, xmlmap:">OverbookedCoveragePercentage"}
							],
                 xmlReader: {
                     root: "Data",
                     row: "Block",
                 ...
                 caption: '<spring:theme code="text.account.ReporteBlocks" />',
                 loadonce: true,
  				viewrecords: true,
                  autowidth: true,
                 height: 440,
