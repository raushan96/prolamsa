			...
			<div class="item_container_holder" style="display: block;">
				...
				<div class="item_container">
					<table class="table_budget">
						...
						<tr>
							<td><spring:theme
								...
								<%-- NO esta habilitado Management Unit
									<td><a href="${unitDetailsUrl}">${permissionData.unit.name}</a></td>
								--%>
							<td>${permissionData.unit.name}</td>
						</tr>
						<tr>
							<td><spring:theme
					...
					<div class="main-right-footer clearfix">
						<a href="${editPermissionDetailsUrl}" class="button yellow positive button-float-right"><spring:theme code="text.company.costCenter.button.displayName" /></a>
						<c:choose>
							<c:when test="${permissionData.active}">
								<a href="${disableUrl}" class="button yellow positive button-float-right"><spring:theme code="text.company.budget.disableButton.displayName" /></a>
							</c:when>
							<c:otherwise>
								<a href="${enableUrl}" class="button yellow positive button-float-right"><spring:theme code="text.company.budget.enableButton.displayName" /></a>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
