	...
	<div class="grid-container">
		...
		<div class="span-20 last main-rightXXX" style="padding-bottom: 30px !important;">
			<div class="title_holder">
				<h2><spring:theme code="checkout.quickOrderConfirmation.thankYou"/></h2>
			</div>		
			<div class="item_container_holder">
		   		<div class="item_container">
		   			<div>
		   				<p><spring:theme code="checkout.quickOrderConfirmation.message"/></p>
		   			</div>
		   			
		   			<c:if test="${isOrderSplittedDueHSS eq true}">
		   				<div class="messageForSplit">
		   					<p><spring:theme code="checkout.quickOrderConfirmation.hssOrderSplitted.message"/></p>
		   				</div>
		   			</c:if>
