     ...
     $.fn.gantt = function (options) {
         ...
         */
         ...
         var core = {
             ...
             // the entire chart
             createProgressBar: function (days, cls, desc, label, dataObj, progress, blockCode, od) {
                 ...
                 //alert("barMarg " +barMarg);
                 //Esto si va onclick="clickEnProgreso();"
                 var bar = $('<div class="bar" id="barra" blockCode="' + blockCode + '" od="' + od + '" onclick="clickEnProgreso(this);" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow=' + progress + ' ><div onclick="clickEnProgreso(this);" id="progress" blockCode="' + blockCode + '" od="' + od + '" style="width: ' + progress + '%;" class="fn-label">' + progress + '%</div></div>')
                         .addClass(cls)
                         .css({
				...
				/* 
				var bar = $('<div id=' + label + ' class="ui-progressbar ui-widget ui-widget-content ui-corner-all" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="87"><div class="ui-progressbar-value ui-widget-header ui-corner-left" style="width: 87%;"></div></div>')
					 .css({
                     width: ((cellWidth * days) - barMarg) + 2
                 })
                 .data("dataObj", dataObj);
                         ...
                         $.each(entry.values, function (j, day) {
                             ...
                             switch (settings.scale) {
                                 ...
                                 case "weeks":
                                     ...
                                     _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
                                     //_bar = _bar + 'role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="37"';
                                     //alert(_bar.css);
                                     datapanel.append(_bar);
                                     break;
...
//                         + '<div class="fn-gantt-loader-spinner"><span>' + settings.waitText + '</span></div></div>');
         ...
         var tools = {
             ...
             getProgressBarMargin: function () {
                 ...
                 //alert(tools._getProgressBarMargin);
