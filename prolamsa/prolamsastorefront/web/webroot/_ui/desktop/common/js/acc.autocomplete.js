	...
	bindSearchAutocomplete: function ()
	{
		...
		if (option)
		{
                            ...
                            $.each(data.products, function (i, obj)
                            {
                                autoSearchData.push(
                                        {value: obj.name,
                                            ...
                                            // NEORIS_CHANGE, no price or images on products
            ...
            }).data("autocomplete")._renderItem = function (ul, item)
            {
                ...
                {
                    renderHtml = "<a href='?q=" + item.value + "' class=''>" + item.value + "</a>";
                ...
                {
                    var renderHtml = "<a href='" + ACC.config.contextPath + item.url + "' class='product'>";
