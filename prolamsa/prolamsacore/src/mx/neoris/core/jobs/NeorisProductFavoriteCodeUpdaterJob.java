 ...
 * 
 */
public class NeorisProductFavoriteCodeUpdaterJob extends AbstractJobPerformable<CronJobModel>
{
	private static final Logger LOG = Logger.getLogger(NeorisProductFavoriteCodeUpdaterJob.class);
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		try
		{
			...
			{
				LOG.info("Start updating favorite product code for catalog " + eachCatalogId);
				...
				for (final ProlamsaProductModel eachProductModel : allProducts)
				{
					...
					eachProductModel.setCodeForFavorites(eachProductModel.getCode());
