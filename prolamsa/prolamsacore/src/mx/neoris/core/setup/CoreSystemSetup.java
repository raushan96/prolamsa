 ...
 */
@SystemSetup(extension = ProlamsaCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/prolamsacore/import/essential-data.impex");
		importImpexFile(context, "/prolamsacore/import/countries.impex");
		importImpexFile(context, "/prolamsacore/import/delivery-modes.impex");

		importImpexFile(context, "/prolamsacore/import/themes.impex");
	}
	...
	{
		// NEORIS_CHANGE
		boolean importSites = getBooleanSystemSetupParameter(context, IMPORT_SITES);
		importSites = false;
		...
		{
			importImpexFile(context, "/prolamsacore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/prolamsacore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/prolamsacore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/prolamsacore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/prolamsacore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/prolamsacore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/prolamsacore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/prolamsacore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/prolamsacore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/prolamsacore/import/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/prolamsacore/import/catalogs-sync.impex", true);
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/prolamsacore/import/productCatalogs/" + catalogName + "ProductCatalog/catalog.impex", true);
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/prolamsacore/import/stores/" + storeName + "/solr.impex");

		createSolrIndexerCronJobs(storeName + "Index");

		importImpexFile(context, "/prolamsacore/import/stores/" + storeName + "/solrtrigger.impex");
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/prolamsacore/import/contentCatalogs/" + catalogName + "ContentCatalog/catalog.impex", true);
		importImpexFile(context, "/prolamsacore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex", false);
		importImpexFile(context, "/prolamsacore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-mobile-content.impex",
				false);

		importImpexFile(context, "/prolamsacore/import/contentCatalogs/" + catalogName + "ContentCatalog/email-content.impex",
				false);
	...
	protected void importStore(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/prolamsacore/import/stores/" + storeName + "/store.impex");
		importImpexFile(context, "/prolamsacore/import/stores/" + storeName + "/site.impex");
