 ...
 */
public class PreparePendingApprovalOrderForPublishToSAPAction extends AbstractSimpleDecisionAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(PreparePendingApprovalOrderForPublishToSAPAction.class);
