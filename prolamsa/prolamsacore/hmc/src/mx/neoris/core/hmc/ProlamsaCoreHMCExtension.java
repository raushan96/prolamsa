...
/**
 * Provides necessary meta information about the prolamsacore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class ProlamsaCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ProlamsaCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "mx.neoris.core.hmc.locales";
